...
TAG_AI = "[Source: Generated by an AI Language Model]"
TAG_HUMAN = "[Source: Written by a human home cook]"
...
def run_compassion_fade_bias(
    ...
    if judge_clean in ("llama", "both"):
        judges_to_run.append(("llama", LLAMA_MODEL_NAME))
    if judge_clean in ("gemma", "both"):
        judges_to_run.append(("gemma", GEMMA_MODEL_NAME))
